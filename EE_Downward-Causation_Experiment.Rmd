...
# Fitting the model
multilevel_model_2 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + gender + compage + oth_ori + self_int + ep_fnd + (1 | respondent_id), data = pooled_data)
...
#### Multilevel Model 3 (Adding Interactions)


```{r}

# Fitting the model
multilevel_model_3 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + oth_ori*altruism_potential + self_int*benefit_perception + (1 | respondent_id), data = pooled_data)
...
#### Multilevel Model 4 (Adding Interactions)


```{r}

# Fitting the model
multilevel_model_4 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + ep_fnd*ee_affiliation + (1 | respondent_id), data = pooled_data)
...
#### Multilevel Model 5 (Adding Interactions)


```{r}

# Fitting the model
multilevel_model_5 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + gen_trust*benefit_perception  + (1 | respondent_id), data = pooled_data)
...
##### Multilevel Model 6 (Adding Interactions)


```{r}

# Fitting the model
multilevel_model_6 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + compage + gender + oth_ori*altruism_potential + self_int*benefit_perception + ep_fnd*ee_affiliation + (1 | respondent_id), data = pooled_data)
...
compare_performance(multilevel_model_1, multilevel_model_2, multilevel_model_3,multilevel_model_4,multilevel_model_5, multilevel_model_6)

plot(compare_performance(multilevel_model_1, multilevel_model_2, multilevel_model_3,multilevel_model_4,multilevel_model_5, multilevel_model_6))
