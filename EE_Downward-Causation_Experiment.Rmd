...
# Fitting the model
multilevel_model_1 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + positive_outcome_expectation + benefit_perception + (1 | respondent_id), 
                         data = pooled_data)
...
#### Multilevel Model 2 (Adding Self Interest + Other Orientation)


```{r}

# Fitting the model
multilevel_model_2 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + positive_outcome_expectation + benefit_perception + self_int + oth_ori  + oth_ori*altruism_potential + self_int*benefit_perception + self_int*altruism_potential + oth_ori*benefit_perception + (1 + self_int + oth_ori | respondent_id), data = pooled_data)
...
compare_performance(multilevel_model_1, multilevel_model_2)

plot(compare_performance(multilevel_model_1, multilevel_model_2))
