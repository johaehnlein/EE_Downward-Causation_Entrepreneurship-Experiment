...
res <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + positive_outcome_expectation + benefit_perception + age + gender + pubfund + programpart + startupcenter + (1|respondent_id), REML = TRUE, data = data)
