...
# Optionally, create output table using `flextable`
results_table_rirs_no_cli <- flextable(model_results_for_table_rirs_no_cli)
print(results_table_rirs_no_cli, preview = "html")
...
# Display model performance
multilevel_model_rirs_cli_perf <- performance::model_performance(multilevel_model_rirs_cli)

multilevel_model_rirs_cli_perf

r2(multilevel_model_rirs_cli)
