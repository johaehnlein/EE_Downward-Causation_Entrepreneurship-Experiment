...
# Unstandardized Confidence Intervals
confint_rifs <- confint(rifs_model, level = 0.95)
print(confint_rifs)
...
confint_rifs_std <- confint(rifs_model_std, level = 0.95)
print(confint_rifs_std)
...
# Unstandardized Confidence Intervals
confint_rirs_no_cli <- confint(rirs_model_no_cli, level = 0.95)
print(confint_rirs_no_cli)
...
# Sstandardized Confidence Intervals
confint_rirs_no_cli_std <- confint(rirs_model_no_cli_std, level = 0.95)
print(confint_rirs_no_cli_std)
...
# Unstandardized Confidence Intervals
confint_multilevel_model_rirs_cli <- confint(multilevel_model_rirs_cli, level = 0.95)
print(confint_multilevel_model_rirs_cli)
...
# Standardized Confidence Intervals
confint_multilevel_model_rirs_cli_std <- confint(multilevel_model_rirs_cli_std, level = 0.95)
print(confint_multilevel_model_rirs_cli_std)
