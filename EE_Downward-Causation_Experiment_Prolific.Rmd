<<<<<<< HEAD
---
title: "EE_Downward-Causation_Conjoint_Prolific"
...
# Fitting the model
multilevel_model <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + positive_outcome_expectation + benefit_perception + self_int + oth_ori  + oth_ori*altruism_potential + self_int*benefit_perception + (1 + self_int + oth_ori | respondent_id), data = pooled_data)
