...
data |>
  select(eecontlike, age, gender, compage, busexp, pubfund, programpart, gen_trust, self_int, oth_ori, ese, ep_inv, ep_dev, ep_fnd) |> #selecting variables
...
# Fitting the model
pooled_model <- lm(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + gender + compage + pubfund + startupcenter + programpart + gen_trust + self_int + oth_ori + ep_fnd, data = pooled_data)
