...
# Fitting the model
multilevel_model_8.1 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + compage + gender + oth_ori:altruism_potential + self_int:benefit_perception + ep_fnd*ee_affiliation + (1 + oth_ori + self_int | respondent_id), data = pooled_data)
...
##### Multilevel Model 9 (Adding Interactions - Target Model 2)


```{r}

# Fitting the model
multilevel_model_9 <- lmer(eecontlike ~ ee_support_reception + ee_affiliation + ee_relationships + altruism_potential + ee_gain_perception + benefit_perception + age + compage + gender + oth_ori*altruism_potential + self_int*benefit_perception + ep_fnd*ee_affiliation + + ex_or*ee_relationships + (1 | respondent_id), data = pooled_data)

# Displaying the results
tidy(multilevel_model_9, effects = "fixed") |> 
  select(term, estimate, std.error, p.value) |> 
  mutate(p.value = round(p.value, digits = 3))


# Display model performance
model_9_perf <- performance::model_performance(multilevel_model_9)

model_9_perf

r2(multilevel_model_9)
...
compare_performance(multilevel_model_1, multilevel_model_2, multilevel_model_3, multilevel_model_3.1, multilevel_model_4,multilevel_model_5, multilevel_model_6, multilevel_model_7, multilevel_model_8, multilevel_model_8, multilevel_model_8.1, multilevel_model_9)

plot(compare_performance(multilevel_model_1, multilevel_model_2, multilevel_model_3, multilevel_model_3.1, multilevel_model_4,multilevel_model_5, multilevel_model_6, multilevel_model_7, multilevel_model_8, multilevel_model_8, multilevel_model_8.1, multilevel_model_9))
